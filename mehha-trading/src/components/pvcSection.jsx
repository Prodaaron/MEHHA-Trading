  ...
  return (
    <div className='pvc-section' style={{backgroundImage: `url(${pvcShoes})`, backgroundSize: 'cover', backgroundPosition: 'center'}}>
      <div className="content-card">
        <p>For more than 15 years, Mes-Arg Plast has been a trusted name in Ethiopia’s footwear industry. We specialize in the production of high-quality, durable, and in-demand PVC shoes, boots, and flops, meeting the needs of diverse customers across the country.</p>
        ...
        <p>With nearly two decades of industry experience, Mes-Arg Plast is committed to maintaining high production standards, expanding our reach, and consistently delivering products that meet the evolving demands of the Ethiopian market.</p>
      </div>
    </div>
  )
}
