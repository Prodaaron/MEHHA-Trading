  ...
  return (
    <div className='pvc-section' style={{backgroundImage: `url(${rawMaterial})`, backgroundSize: 'cover', backgroundPosition: 'center'}}>
      <div className="content-card">
        <p>For over 5 years, Mes-Arg Plast has been at the forefront of Ethiopia’s plastic manufacturing sector, producing PVC raw materials locally rather than relying on imports. This strategic shift has allowed us to play a vital role in supporting the country’s industrial growth while strengthening our own production capacity.</p>
